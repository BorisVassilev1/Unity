	...
	SubShader
	{
		...
		Pass
		{
			...
			#include "LightweightLighting.cginc"
							...
							float4 _PBRMaster_82B73182_Albedo;
							float4 _PBRMaster_82B73182_Normal;
							float4 _PBRMaster_82B73182_Emission;
							float _PBRMaster_82B73182_Metallic;
							float _PBRMaster_82B73182_Smoothness;
							float _PBRMaster_82B73182_Occlusion;
							float _PBRMaster_82B73182_Alpha;
							GraphVertexInput PopulateVertexData(GraphVertexInput v){
								return v;
							}
							SurfaceDescription PopulateSurfaceData(SurfaceInputs IN) {
								SurfaceDescription surface = (SurfaceDescription)0;
								surface.Albedo = _PBRMaster_82B73182_Albedo;
								surface.Normal = _PBRMaster_82B73182_Normal;
								surface.Emission = _PBRMaster_82B73182_Emission;
								surface.Metallic = _PBRMaster_82B73182_Metallic;
								surface.Smoothness = _PBRMaster_82B73182_Smoothness;
								surface.Occlusion = _PBRMaster_82B73182_Occlusion;
								surface.Alpha = _PBRMaster_82B73182_Alpha;
								return surface;
							}
